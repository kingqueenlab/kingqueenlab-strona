const products = [
  ...
  { id: "cagrilintide", name: "Cagrilintide", category: "Amylin analogue research", description: "A long-acting amylin analogue reference material discussed in metabolic research literature.", molecular: "Synthetic peptide analogue used in amylin pathway research.", image: "kql-logo-transparent.webp", references: ["Amylin pathway literature", "Metabolic research review", "Laboratory reference notes"], options: [{ label: "5mg Vial", price: 50, image: "kql-logo-transparent.webp", fit: "placeholder" }, { label: "10mg Vial", price: 90, image: "kql-logo-transparent.webp", fit: "placeholder" }] },
  { id: "dermorphin", name: "Dermorphin", category: "Peptide research", description: "A peptide reference material used for laboratory and educational literature review.", molecular: "Heptapeptide reference compound.", image: "kql-logo-transparent.webp", references: ["Peptide reference literature", "Molecular review", "Laboratory material notes"], options: [{ label: "5mg Vial", price: 40, image: "kql-logo-transparent.webp", fit: "placeholder" }] },
  ...
  { id: "ipamorelin", name: "Ipamorelin", category: "Peptide research", description: "A peptide reference material discussed in growth hormone secretagogue receptor research.", molecular: "Synthetic pentapeptide research reference material.", image: "kql-logo-transparent.webp", references: ["Secretagogue receptor literature", "Peptide research review", "Laboratory material notes"], options: [{ label: "10mg Vial", price: 40, image: "kql-logo-transparent.webp", fit: "placeholder" }] },
  { id: "mots-c", name: "MOTS-C", category: "Mitochondrial peptide research", description: "A mitochondrial-derived peptide discussed in metabolic and cellular research literature.", molecular: "Mitochondrial open reading frame peptide reference material.", image: "mots-c-20mg.webp", references: ["Mitochondrial peptide literature", "Metabolic research review", "Material category notes"], options: [{ label: "40mg Vial", price: 70, image: "kql-logo-transparent.webp", fit: "placeholder" }] },
  ...
  { id: "russian-stack", name: "Russian Stack", category: "Nootropic peptide research", description: "A combined Semax and Selank research blend for laboratory reference review.", molecular: "Combined peptide blend containing Semax and Selank reference materials.", image: "SEMAX&SELANK 20MG.png", references: ["Blend reference notes", "Nootropic peptide overview", "Material category review"], options: [{ label: "20mg Vial", price: 60, image: "SEMAX&SELANK 20MG.png" }] },
  { id: "semaglutide", name: "Semaglutide", category: "Incretin research", description: "A GLP-1 receptor agonist reference material discussed in metabolic research literature.", molecular: "Peptide-based research compound referenced in GLP-1 pathway studies.", image: "kql-logo-transparent.webp", references: ["GLP-1 pathway literature", "Metabolic research review", "Laboratory reference notes"], options: [{ label: "10mg Vial", price: 50, image: "kql-logo-transparent.webp", fit: "placeholder" }, { label: "20mg Vial", price: 80, image: "kql-logo-transparent.webp", fit: "placeholder" }] },
  { id: "tb-500", name: "TB-500", category: "Peptide research", description: "A peptide research material used in laboratory reference and cellular study contexts.", molecular: "Synthetic thymosin beta-4 fragment reference material.", image: "kql-logo-transparent.webp", references: ["Peptide reference literature", "Cellular study contexts", "Laboratory material notes"], options: [{ label: "10mg Vial", price: 45, image: "kql-logo-transparent.webp", fit: "placeholder" }] },
  ...
  { id: "wolverine-stack", name: "Wolverine Stack", category: "Peptide blend research", description: "A combined BPC-157 and TB-500 research blend for laboratory reference review.", molecular: "Combined peptide blend containing BPC-157 and TB-500 reference materials.", image: "kql-logo-transparent.webp", references: ["Blend reference notes", "Peptide research overview", "Laboratory material documentation"], options: [{ label: "BPC-157 & TB-500 Vial", price: 60, image: "kql-logo-transparent.webp", fit: "placeholder" }] }
