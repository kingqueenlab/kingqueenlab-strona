const products = [
  ...
  },
  {
    ...
    category: "Peptide",
    categoryKey: "peptide",
    tagline: "10IU research vial.",
    description:
      "A single-option research catalogue item presented with the new premium product photography set.",
    options: [{ label: "10IU", price: 140, image: "somatropin-10iu.webp" }],
  },
  {
    id: "tesamorelin",
    name: "Tesamorelin",
